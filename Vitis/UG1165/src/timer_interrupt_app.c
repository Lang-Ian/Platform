...
XPAR_FABRIC_I_DGRM_WRAPPER_DGRM_I_AXI_TIMER_0_INTERRUPT_INTR,
...
*/
XScuGic_Enable(&InterruptController, XPAR_FABRIC_I_DGRM_WRAPPER_DGRM_I_AXI_TIMER_0_INTERRUPT_INTR);
return XST_SUCCESS;
}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
xStatus = XTmrCtr_Initialize(&TimerInstancePtr,XPAR_I_DGRM_WRAPPER_DGRM_I_AXI_TIMER_0_DEVICE_ID);
if(XST_SUCCESS != xStatus)
...
XPAR_I_DGRM_WRAPPER_DGRM_I_AXI_TIMER_0_DEVICE_ID,
...
case '2' :
	...
	while(internal_choice != '0')
	{
	print("press a different button you fool\r\n ");
